...
focused on agent-based modeling. Social change is comprised of behavior and opinion change. Each is represented here. Note the code is at v0.2.6, meaning it's a work-in-progress that's subject to change. 
For questions or comments please
[open an issue](https://github.com/SocSci-for-Sustainability/socmod/issues). Thanks!
